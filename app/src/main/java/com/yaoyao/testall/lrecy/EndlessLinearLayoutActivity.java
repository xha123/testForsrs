package com.yaoyao.testall.lrecy;
...
public class EndlessLinearLayoutActivity extends AppCompatActivity{
    ...
    /**服务器端一共多少条数据*/
    private static final int TOTAL_COUNTER = 34;//如果服务器没有返回总数据或者总页数，
                                                // 这里设置为最大值比如10000，什么时候没有数据了根据接口返回判断
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lrecy);
